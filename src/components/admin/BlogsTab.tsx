        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4 text-xs">
              ...
              <div className="col-span-2"><label className="block mb-1 font-bold">Image URL</label><input className="w-full border p-2 rounded-lg dark:bg-slate-800" value={form.coverImage} onChange={e => setForm({...form, image: e.target.value})} /></div>
